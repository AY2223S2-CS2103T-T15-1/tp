...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonRerollStorage addressBookStorage =
                new JsonRerollStorage(temporaryFolder.resolve("addressBook.json"));
    ...
    public void execute_storageThrowsIoException_throwsCommandException() {
        ...
        JsonRerollStorage addressBookStorage =
                new JsonRerollIoExceptionThrowingStub(temporaryFolder.resolve("ioExceptionAddressBook.json"));
     ...
     */
    private static class JsonRerollIoExceptionThrowingStub extends JsonRerollStorage {
        private JsonRerollIoExceptionThrowingStub(Path filePath) {
            super(filePath);
        }

        @Override
        public void saveReroll(ReadOnlyReroll addressBook, Path filePath) throws IOException {
